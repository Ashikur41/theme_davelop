...
<body>
  ...
  <section class="welcome_section layout_padding">
    <div class="container">
      ...
      <div class="layout_padding2">
        <div class="img-box">
          <img src="<?php echo get_template_directory_uri().'/images/welcome.png'?>" alt=""/>
        </div>
    ...
    <div class="container">
	  ...
	  ?>
        <div class="service_box">
		  ...
		  echo __('sorry','mytextdomaindevalop');
		  endif;
		  ?>
        </div>
      </div>
  ...
  <section class="problem_section layout_padding">
    <div class="container">
      ...
      <div class="layout_padding2">
        <div class="img-box">
          <img src="<?php echo get_template_directory_uri().'/images/problem.jpg'?>" alt=""/>
        </div>
        <div class="detail-box">
          <p>
      ...
      <div class="content-container">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="img-box">
              <img src="<?php echo get_template_directory_uri().'/images/smiley.png'?>" alt=""/>
            </div>
            <div class="detail-box">
              <h3>
                99%
          ...
          <div class="col-md-3 col-sm-6">
            <div class="img-box">
              <img src="<?php echo get_template_directory_uri().'/images/monitor.png'?>" alt=""/>
            </div>
            <div class="detail-box">
              <h3>
                4700+
          ...
          <div class="col-md-3 col-sm-6">
            <div class="img-box">
              <img src="<?php echo get_template_directory_uri().'/images/multiple-users-silhouette.png'?>" alt=""/>
            </div>
            <div class="detail-box">
              <h3>
                4500+
          ...
          <div class="col-md-3 col-sm-6">
            <div class="img-box">
              <img src="<?php echo get_template_directory_uri().'/images/bar-chart.png'?>" alt=""/>
            </div>
            <div class="detail-box">
              <h3>
                19000+
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="client_container layout_padding2">
              ...
              <div class="detail-box">
                <div class="img-box">
                  <img src="<?php echo get_template_directory_uri().'/images/received_701772554125808.jpeg'?>" alt=""/>
                </div>
                <div class="name">
                  <h5>
                    Joans Mark
      ...
      <div class="container info_content">
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center align-items-lg-baseline">
          <div class="social-box">
            ...
            <a href="">
              <img src="<?php echo get_template_directory_uri().'/images/linkedin1.png'?>" alt=""/>
            </a>
            <a href="">
              <img src="<?php echo get_template_directory_uri().'/images/instagram1.png'?>" alt=""/>
            </a>
          </div>
